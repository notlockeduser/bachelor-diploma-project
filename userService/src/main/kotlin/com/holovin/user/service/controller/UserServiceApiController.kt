package com.holovin.user.service.controller

import com.holovin.user.service.api.UserServiceClient
...
import com.holovin.user.service.service.Service
...
class UserServiceApiController(
    private val userService: Service
) : UserServiceClient {
